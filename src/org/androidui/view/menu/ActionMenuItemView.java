...
import org.androdui.R;
import org.androidui.view.ViewHasStateListenerSupport;
import org.androidui.view.ViewOnAttachStateChangeListener;
...
public class ActionMenuItemView extends LinearLayout
        ...
        ActionMenuView.ActionMenuChildView, ViewHasStateListenerSupport {
    ...
    private final Set<ViewOnAttachStateChangeListener> mListeners = new HashSet<ViewOnAttachStateChangeListener>();
    ...
    @Override
    public void addOnAttachStateChangeListener(ViewOnAttachStateChangeListener listener) {
        mListeners.add(listener);
    }

    @Override
    public void removeOnAttachStateChangeListener(ViewOnAttachStateChangeListener listener) {
    ...
    protected void onAttachedToWindow() {
        ...
        for (ViewOnAttachStateChangeListener listener : mListeners) {
